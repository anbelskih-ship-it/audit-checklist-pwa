...
describe('buildPdfReportData', () => {
  it('builds detailed report sections and grouped issues for the PDF', () => {
          ...
          sections: [
            {
              ...
              items: [
                { id: '01.1.1', text: 'Заголовок секции', criteria: '' },
                { id: '01.1.2', text: 'Есть сценарий поиска кандидатов', criteria: '' },
                { id: '01.1.3', text: 'Есть еженедельный обзвон базы', criteria: '' },
              ],
            },
            {
              id: '01.2',
              name: 'Адаптация',
              items: [
                { id: '01.2.1', text: 'Заголовок секции', criteria: '' },
                { id: '01.2.2', text: 'Есть план адаптации сотрудников', criteria: '' },
              ],
            },
          ],
        },
          ...
          sections: [
            {
              ...
              name: 'Лиды',
              items: [
                { id: '02.1.1', text: 'Заголовок секции', criteria: '' },
                { id: '02.1.2', text: 'Ведётся разбор качества лидов', criteria: '' },
              ],
            },
          ],
        },
    ...
    const audit: Audit = {
      ...
      answers: {
        '01.1.2': { value: 0, comment: 'Нет единого сценария поиска' },
        '01.1.3': { value: 0, comment: 'Обзвон не ведётся' },
        '01.2.2': { value: 1, comment: '' },
        '02.1.2': { value: 1, comment: '' },
      },
    }
